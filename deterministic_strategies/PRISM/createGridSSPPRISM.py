...
def create_grid(budget, target, size, sizex, pre):
	...
	file = open('grid_PRE_' + str(size) + '_prism.sm', 'w')
	file.write('mdp\n\n')
	...
	for i in range(0, size):
		...
		if str(i) in obs:
			...
			if i - (sizex) < 0:
				...
				file.write(save[str(i) + str(2)] + ': (s\'= ' + str(i - sizex) + ') + ')
			if i + (sizex) > size -1 :
				file.write(save[str(i) + str(3)] + ': (s\'= ' + str(i) + ');\n')
			else:
				file.write(save[str(i) + str(3)] + ': (s\'= ' + str(i + sizex) + ');\n')
		else:
			if i%size == 0:
				file.write('\t\t[move] s=' + str(i) + ' & started -> ' + 'x0' +  ': (s\'=' + str(i) + ') +')
			else:
				file.write('\t\t[move] s=' + str(i) + ' & started -> ' + 'x0' +  ': (s\'=' + str(i-1) + ') +')
			if i%size == sizex-1:
				file.write('x1' + ': (s\'= ' + str(i) + ') + ')
			else:
				file.write('x1' + ': (s\'= ' + str(i + 1) + ') + ')
			if i - (sizex) < 0:
				file.write('x2' + ': (s\'= ' + str(i) + ') + ')
			else:
				file.write('x2' + ': (s\'= ' + str(i - sizex) + ') + ')
			if i + (sizex) > size -1 :
				file.write('x3' + ': (s\'= ' + str(i) + ');\n')
			else:
				file.write('x3' + ': (s\'= ' + str(i + sizex) + ');\n')
...
create_grid(budget, target, size*size, size, pre)